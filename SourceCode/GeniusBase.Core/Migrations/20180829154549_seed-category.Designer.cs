...
namespace GeniusBase.Core.Migrations
{
    ...
    [Migration("20180829154549_seed-category")]
            ...
            modelBuilder.Entity("GeniusBase.Core.Database.Entity.Post.Category", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CategoryIdentifier = "uncategorized", CategoryName = "Uncategorized", CreatedBy = 0, CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), ModifiedBy = 0, ModifiedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                    );
                });
